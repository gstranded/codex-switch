...
/// Example: `codex-switch-sync/v2/db-v6/default/manifest.json`
...
mod tests {
    ...
    fn s3_key_uses_v2_and_correct_format() {
        ...
        assert_eq!(key, "codex-switch-sync/v2/db-v6/default/manifest.json");
    }
    ...
    fn s3_key_matches_expected_pattern() {
        ...
        assert_eq!(parts[0], "codex-switch-sync");
