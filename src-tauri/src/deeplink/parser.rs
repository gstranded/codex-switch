...
//!
//! Parses codexswitch:// and ccswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse a codexswitch:// or ccswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// codexswitch://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "codexswitch" && scheme != "ccswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'codexswitch' or 'ccswitch', got '{scheme}'"
        )));
    }
